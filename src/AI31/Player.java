...
public abstract class Player implements AI31Constants{
  ...
  /**
   * A private subclass that calculates the sum of the player's cards.
   * @author dong-yonkim
   *
   */
  ...
  public double sumOfHand() {
    ...
    if(matchingSuit()==3){if(getCard(0).getFace() == 'A' && getCard(1).getFace() == 'K' && getCard(2).getFace() == 'Q'){return 31.5;}}
  ...
  public double maxPossibleSum(String suit, MiddleHand m) throws PlayingCardException{
